...
Python 2.7 Runtime Needed
--------------------------
* Support for the Python 2.7 runtime
...
#. Download this repository via
   `git clone http://wangkexiong.github.com/gae-flask`
#. Copy the src/ folder to your application's root folder
   Recommand using pyCharm to create/edit/debug your python based GAE application
#. Set the application id in `src/app.yaml`
#. Add datastore models under `src/application/models/`
#. Add application views under `src/application/views/`
   Recommand using blueprint for url mapping
#. Add forms under `src/application/forms/`
#. Configure your application in `src/application/settings.py`
#. Extending your flask application by editing `src/application/__init__.py`
#. Before running, your must generate the secret keys for CSRF protection
   `runme1st.py -f -r 40`, which will generate the
...
---------------------------
To support unit testing requires installation of Jinja2, PIL, and unittest2,
...
-----------------------
Themes is introduced, refer to Flask-Themes
